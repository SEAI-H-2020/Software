    ...
    app.post("/measurements_tstamp", async (req, res) => {
        ...
        */
        try {
            ...
            "VALUES ($1, $2, $3, $4, $5, $6)", [req.body.tstamp, req.body.temperature, req.body.humidity, req.body.wind, req.body.noise_level, req.body.voltage]);
            const newMeasurement = await pool.query(
                "INSERT INTO measurements (tstamp, temperature, humidity, wind, noise_level, voltage) \
                        VALUES ($1, $2, $3, $4, $5, $6)", [req.body.tstamp, req.body.temperature, req.body.humidity, req.body.wind,
            req.body.noise_level, req.body.voltage]);
